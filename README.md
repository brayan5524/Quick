# Proyecto de Configuración y Comandos

## Paso 1: Clonar el proyecto

# Clona el repositorio desde la URL correspondiente.
...
# Cuando es un JSON, se especifica en cada URL que es un JSON (en el POST y en los dos GETs que aparecen en la documentación).
